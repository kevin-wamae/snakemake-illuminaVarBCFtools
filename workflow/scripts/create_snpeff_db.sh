...
GENOME_URL='https://plasmodb.org/common/downloads/release-63/Pfalciparum3D7/'
GENOME_FASTA='fasta/data/PlasmoDB-63_Pfalciparum3D7_Genome.fasta'
GENOME_CDS='fasta/data/PlasmoDB-63_Pfalciparum3D7_AnnotatedCDSs.fasta'
GENOME_PROT='fasta/data/PlasmoDB-63_Pfalciparum3D7_AnnotatedProteins.fasta'
GENOME_GFF='gff/data/PlasmoDB-63_Pfalciparum3D7.gff'
...
# *****************************************************************
DATADIR='output/1_annotation_db'
